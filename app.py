...
private_key_bytes = open('D:/labs/moca_mmse/private.pem', 'rb').read()
...
def database_connect() :
    global conn
    engine = create_engine("mysql+pymysql://root:01089590437@210.115.229.92:35306/?charset=utf8mb4", encoding='utf-8')
    conn = engine.connect()
...
def database_connect_engine() :
    global conn
    global engine_value
    engine_value = create_engine("mysql+pymysql://root:01089590437@210.115.229.92:35306/moca?charset=utf8mb4", encoding='utf-8')
...
#    dir_path = './'
    ...
    public_key_bytes = open(dir_path + 'public_t.pem', 'rb').read() # 공개키 파일을 읽기
...
#    dir_path = './'
    ...
    private_key_bytes = open(dir_path + 'private_t.pem', 'rb').read()
